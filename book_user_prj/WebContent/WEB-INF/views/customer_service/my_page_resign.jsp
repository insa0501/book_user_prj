                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                <div class="li_chkbox_wrap">
                                    <span>
                                        <input type="checkbox" value="void" class="reason_chk" id="chk1" name="chk"><label for="chk1">찾는 도서가 없어서</label>
                                    </span>
                                    <span>
                                        <input type="checkbox" value="void" class="reason_chk" id="chk2" name="chk"><label for="chk2">상품 가격 불만</label>
                                    </span>
                                    <span>
                                        <input type="checkbox" value="void" class="reason_chk" id="chk3" name="chk"><label for="chk3">배송 불만</label>
                                    </span>
                                    <span>
                                        <input type="checkbox" value="void" class="reason_chk" id="chk4" name="chk"><label for="chk4">고객서비스 불만</label>
                                    </span>
                                    <span>
                                        <input type="checkbox" value="void" class="reason_chk" id="chk5" name="chk"><label for="chk5">교환/환불/반품 불만</label>
                                    </span>
                                </div>
                            </li>
                            <li>
                                <input type="button" class="btn_cancel btn" value="취소">
                                <input type="button" class="btn_submit btn" value="회원 탈퇴">
                            </li>
                        </ul>
                    </form>
